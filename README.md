...
*This is the Degen Wonderland door to
[`bitcoin-federated-time`](https://github.com/PacsArcade/bitcoin-federated-time). Same
clock, same math, same honesty — told at the tea-party. The plain engineering door is
[over at the arcade](https://github.com/PacsArcade/bitcoin-federated-time). If you want
...
positions. Nobody had followed the numbers down to what they *mean*. So the degenz dug —
...
- **The clock** — `block_beat()`: the 10/6 face. No second digits — the seconds ride the Pac ring (block-age mod 60, always ~). Slow on purpose; this is a clock
...
- **The sky** — `bft.sky`: a block-timed moon (new on the 1st, full mid-month, home by the
  ...
  the fren the Rat cheated out of the Great Race, finally given a year. In Wonderland the
...
on the clock's flip side hits zero and the arcade opens the surprise it has been saving.
No spoilers, not even here. Be there.
...
Stay curious long enough and this is what happens: you keep digging, you keep fitting
together puzzle pieces nobody else believed were from the same set, and one day the whole
picture assembles — a future with bitcoin in it, and **trust and abundance for all**. This clock is one piece of
that picture, placed.
...
coin will be worth, and anyone who says otherwise is a dragon in a fren's coat.
...
*MIT, from the Pac's Arcade non-profit. The plain telling, the guides for sharp
five-year-olds, and the package all live at
[PacsArcade/bitcoin-federated-time](https://github.com/PacsArcade/bitcoin-federated-time);
the playable clocks live right here in [studies/](studies/). Lewis Carroll is public domain
and would, we suspect, have understood block height immediately.*
